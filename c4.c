...
EmitZCode(int *pc, int *e, int *main)
{
	...
	printf("Global d;\n");
	printf("Global s;\n");
	printf("Array locals -> 8192;\n");
	printf("Array memory -> 32767;\n");
	printf("Array data -> ");
	while (s<data)
	{
		printf("%d ", s[0]);
	...
	printf("\t@storew d 6 a;\n");
	printf("\t@storew d 7 0;\n");
	printf("\t@storeb d 16 'c';\n");
	printf("\t@storeb d 17 '4';\n");
	printf("\t@storeb d 18 0;\n");
	printf("\t@storeb d 19 '-';\n");
	printf("\t@storeb d 20 's';\n");
	printf("\t@storeb d 21 0;\n"); 
	printf("\t@storeb d 22 'a';\n");
	printf("\t@storeb d 23 '.';\n");
	printf("\t@storeb d 24 'c';\n");
	printf("\t@storeb d 25 0;\n"); 
	printf("\t@add d 4 -> a;\n");
	printf("\t@storew d 0 a;\n"); // argv
	printf("\t@storew d 1 3;\n"); // argc
	printf("\t@call F%x d -> d;\n", main);
	...
	printf("\t@nop;\n");
	printf("];\n\n");
	printf("[Read bp fd buf count;\n");
	printf("\t@loadw bp 0 -> count;\n");
	printf("\t@loadw bp 1 -> buf;\n");
	printf("\t@loadw bp 2 -> fd;\n");
	printf("\t@jl count 240 ?smallRead;\n");
	printf("\t @store count 240;\n");
	printf(".smallRead;\n");
	printf("\t@storeb buf 0 count;\n");
	printf("\t@storeb bp 0 0;\n");
	printf("\t@sread buf bp;\n");
	printf("\t@loadb buf 0 -> count;\n");
	printf("\t@dec count;\n");
	printf("\t@store fd count;\n");
	printf(".readLoop;\n");
	printf("\t@jz count ?readDone;\n");
	printf("\t @loadb  buf 1 -> bp;\n");
	printf("\t @storeb buf 0 bp;\n");
	printf("\t @inc buf;\n");
	printf("\t @dec count;\n");
	printf("\t jump readLoop;\n");
	printf(".readDone;\n");
	printf("\t@ret fd;\n");
	printf("];\n\n");
	printf("[Memcmp bp src1 src2 size i;\n");
	printf("\t@loadw bp 0 -> size;\n");
	printf("\t@loadw bp 1 -> src2;\n");
	printf("\t@loadw bp 2 -> src1;\n");
	printf("\t@store bp 0;\n");
	printf(".memcmpLoop;\n");
	printf("\t@je i size ?memcmpReturn;\n");
	printf("\t @loadb src2 i -> sp;\n");
	printf("\t @loadb src1 i -> sp;\n");
	printf("\t @sub sp sp -> bp;\n");
	...
	printf(".putsLoop;\n");
	printf("\t@loadb p 0 -> c;\n");
	printf("\t@jz c ?putsDone;\n");
	printf("\t @print_char c;\n");
	printf("\t @inc p;\n");
	printf("\t jump putsLoop;\n");
	printf(".putsDone;\n");
	printf("\t@nop;\n");
	printf("];\n\n");
	...
	printf(".printFLoop;\n");
	printf("\t @loadb d 0 -> c;\n");
	printf("\t @jz c ?printDone;\n");
	printf("\t  @je c '%%' ?~printFEscape;\n");
	printf("\t   @inc d;\n");
	printf("\t   @loadb d 0 -> c;\n");
	printf("\t   @je c 's' ?~printFString;\n");
	printf("\t    @dec numArgs;\n");
	printf("\t    @loadw bp numArgs -> c;\n");
	printf("\t    @call Puts c -> c;\n");
	printf("\t    jump printFDone;\n");
	printf(".printFString;\n");
	printf("\t   @je c 'd' 'x' ?~printFNumber;\n");
	printf("\t    @dec numArgs;\n");
	printf("\t    @loadw bp numArgs -> c;\n");
	printf("\t    @print_num c;\n");
	printf("\t    jump printFDone;\n");
	...
	while (pc!=e)
	{
		...
		else if (i == OPEN) printf("\t@store a 1;\n");
		else if (i == READ) printf("\t@call Read argStack -> a;\n");
